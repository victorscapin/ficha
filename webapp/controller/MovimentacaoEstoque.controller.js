...
sap.ui.define([
	...
	return Controller.extend("Belagricola.Ficha.controller.MovimentacaoEstoque", {
		...
		onNewPress: function () {
			this.getOwnerComponent().getRouter().navTo("RouteMovimentacaoEstoqueData");
		},

		onMovimentacaoEstoquePress: function (evt) {
			...
			MessageBox.show("Deseja remover esse item?", {
				...
				onClose: function (sButton) {
					if (sButton === MessageBox.Action.YES) {
						var aItems = me.getView().byId("grdMovimentacaoEstoque").getItems();
						var aSelectedItems = [];
						...
						jQuery.ajax({
							url: "/ServiceOData/FichaInteligente/MovimentacaoEstoque/delete.xsjs",
							async: false,
							TYPE: "POST",
		...
		onMovimentacaoEstoqueSelect: function (evt) {
